...
public class EntityTraderLlamaPet extends TraderLlama implements IEntityAnimalPet, EntityPetGiveMeAccess{
	
	protected ITraderLlamaPet pet;
	private final INMSEntityPetHandle petHandle;
	
	public EntityTraderLlamaPet(Level world, ITraderLlamaPet pet){
