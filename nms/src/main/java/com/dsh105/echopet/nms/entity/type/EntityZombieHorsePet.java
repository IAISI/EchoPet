...
public class EntityZombieHorsePet extends ZombieHorse implements IEntityAnimalPet, EntityPetGiveMeAccess{
	
	protected IZombieHorsePet pet;
	private final INMSEntityPetHandle petHandle;
	
	public EntityZombieHorsePet(Level world, IZombieHorsePet pet){
